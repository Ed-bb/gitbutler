import { type Focusable, FOCUS_MANAGER, type FocusableOptions } from '$lib/focus/focusManager.svelte';
...
<script>
	import { createStackOptions } from '$lib/focus/focusManager.svelte';
